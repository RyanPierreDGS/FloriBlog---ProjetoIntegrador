...
const questions = [
  ...
  {
    question:
      "Qual cultura agrícola é a principal responsável por fazer do Mato Grosso o maior produtor agrícola do Brasil?",
    answers: [
...
function nextQuestion() {
  ...
  if (currentQuestionIndex < questions.length) {
    ...
    alert(
      `Parabéns, ${playerName}! Você completou o quiz com ${score} pontos.`
    );
