...
const questions = [
  {
    ...
    answers: [
      ...
      },
      {
        ...
        correct: false,
        explanation:
          "As flores do Manacá da Serra não são amarelas, mas mudam de branco para rosa e roxo.",
      },
      {
  ...
  },
  {
    ...
    answers: [
      ...
      },
      {
        ...
        correct: false,
        explanation:
          "Embora algumas possam atrair polinizadores, essa não é sua principal função.",
      },
      {
    ...
    answers: [
      {
        ...
        correct: false,
        explanation:
          "A Quaresmeira pode alcançar alturas maiores do que 5 metros.",
      },
      {
        text: "12 metros",
        correct: true,
        explanation: "A Quaresmeira pode alcançar até 12 metros de altura.",
      },
      {
        text: "20 metros",
        correct: false,
        explanation:
          "A altura máxima da Quaresmeira é de 12 metros, não 20 metros.",
      },
      {
        text: "8 metros",
        correct: false,
        explanation:
          "Embora a Quaresmeira possa medir 8 metros, essa não é sua altura máxima.",
      },
    ],
  },
  {
    ...
    answers: [
      ...
      },
      {
        ...
        correct: false,
        explanation:
          "A Monstera adansonii é uma planta de interior, não uma árvore de sombra.",
      },
      {
        text: "Em projetos de reflorestamento",
        correct: false,
        explanation:
          "A Monstera adansonii não é comumente usada em projetos de reflorestamento.",
      },
    ],
  },
  {
    ...
    answers: [
      ...
      },
      {
        ...
        correct: false,
        explanation:
          "A Monstera adansonii não é conhecida como 'Cacto-da-Páscoa'.",
      },
      {
        text: "Lobelia brasiliensis",
        correct: false,
        explanation:
          "A Lobelia brasiliensis não é conhecida como 'Cacto-da-Páscoa'.",
      },
      {
        text: "Manacá da Serra",
        correct: false,
        explanation:
          "O Manacá da Serra não é conhecido como 'Cacto-da-Páscoa'.",
      },
    ],
  },
  {
    ...
    answers: [
      ...
      },
      {
        ...
        correct: false,
        explanation:
          "A Lobelia brasiliensis cresce em várias condições, não apenas sombra total.",
      },
    ],
  },
  {
    question:
      "07 - Qual é a vantagem de usar um vaso autoirrigável para a Monstera adansonii?",
    answers: [
      {
      ...
      },
      {
        ...
        correct: false,
        explanation:
          "A Monstera adansonii é conhecida mais por suas folhas do que por flores.",
      },
      {
      ...
      },
      {
        ...
        correct: false,
        explanation:
          "Um vaso autoirrigável não altera a necessidade de luz da Monstera adansonii.",
      },
    ],
  },
  {
    question:
      "08 - Qual ação é recomendada para a preservação da Lobelia brasiliensis?",
    answers: [
      {
      ...
      },
      {
        ...
        correct: false,
        explanation:
          "O desmatamento contribui para o declínio da Lobelia brasiliensis.",
      },
      {
      ...
      },
      {
        ...
        correct: false,
        explanation:
          "O uso de pesticidas pode prejudicar ainda mais a Lobelia brasiliensis.",
      },
    ],
  },
  {
    ...
    answers: [
      ...
      },
      {
        ...
        correct: false,
        explanation:
          "A Flor-de-Maio não é cultivada para a produção de frutos.",
      },
      {
      ...
      },
      {
        ...
        correct: false,
        explanation:
          "A Flor-de-Maio não é geralmente utilizada em reflorestamento.",
      },
    ],
  },
  {
    ...
    answers: [
      ...
      },
      {
        ...
        correct: false,
        explanation:
          "A principal função da captura de insetos não é a polinização.",
      },
      {
        text: "Para competir com outras plantas",
        correct: false,
        explanation:
          "A captura de insetos não está relacionada à competição com outras plantas.",
      },
    ],
  },
];
